    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="filter">
                ...
                <div class="row">
                    <div class="col-md-3">
                        {!! Form::select('resturant_id',$resturant->get()->pluck('resturant_details','id')->toArray(),null,[
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <button type="submit" class="btn btn-flat bg-navy btn-block"><i class="fa fa-search"></i>
                            </button>
                        </div>
                    </div>
                </div>
