                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($offers as $offer)
                            <tr id="removable{{$offer->id}}">
                                ...
                                <td>{{$offer->name}}</td>
                                <td>
{{--                                    @if(count($offer->restaurant)){{$offer->restaurant->name}}@endif--}}
                                    {{optional($offer->resturant)->name}}
                                </td>
                                <td>
                                    <a href="{{asset($offer->image)}}" data-lightbox="{{$offer->id}}" data-title="{{$offer->description}}"><img src="{{asset($offer->image)}}" alt="" style="height: 60px;"></a>
                                </td>
