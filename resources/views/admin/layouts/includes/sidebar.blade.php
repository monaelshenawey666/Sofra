    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p>{{Auth::user()->name}}</p>qqqqqqqqqqqq
{{--                <a href="#"><i class="fa fa-circle text-success"></i> {{Auth::user()->roles()->first()->display_name}}--}}
{{--                </a>--}}
            </div>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{url('admin/resturant')}}">عرض المطاعم</a></li>
