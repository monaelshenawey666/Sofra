    ...
    <script type="text/javascript"
            src='http://maps.google.com/maps/api/js?libraries=places&key=AIzaSyAJDNGhvRiWXMvI7VjALT363E3QMOqp6j8'></script>
...
{{--        @endif--}}
{{--    </script>--}}
    <script src="{{asset('js/mona.js')}}"></script>
    <script>
